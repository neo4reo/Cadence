...
################################################################################
rule PCB (width 0.3000)
rule PCB (clearance 0.3000 (type buried_via_gap))
rule PCB (clearance 0.1270 (type wire_wire))
rule PCB (clearance 0.3000 (type wire_smd))
rule PCB (clearance 0.3000 (type wire_pin))
rule PCB (clearance 0.3000 (type wire_via))
rule PCB (clearance 0.3000 (type smd_smd))
rule PCB (clearance 0.3000 (type smd_pin))
rule PCB (clearance 0.3000 (type smd_via))
rule PCB (clearance 0.3000 (type pin_pin))
rule PCB (clearance 0.3000 (type pin_via))
rule PCB (clearance 0.3000 (type via_via))
rule PCB (clearance 0.3000 (type test_test))
rule PCB (clearance 0.3000 (type test_wire))
rule PCB (clearance 0.3000 (type test_smd))
rule PCB (clearance 0.3000 (type test_pin))
rule PCB (clearance 0.3000 (type test_via))
...
set mhole_pin off
rule PCB (clearance 0.3000 (type bbvia_testpin))
set bbvia_testpin on
rule PCB (clearance 0.2032 (type mhole_via))
set mhole_via off
rule PCB (clearance 0.3000 (type bbvia_testvia))
...
set mhole_mhole on
rule PCB (clearance 0.3000 (type bbvia_bondpad))
...
rule pcb (staggered_via on (min_gap 0.3000))
